...
public class TvTrackerEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<TvTrackerDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also TvTrackerDbContextFactory for EF Core tooling. */
